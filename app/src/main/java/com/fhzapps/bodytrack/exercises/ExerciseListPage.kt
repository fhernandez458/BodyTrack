...
fun ExerciseListPage(
    ...
    onExerciseClicked: (exerciseId: String) -> Unit,
    // onLoadMore: () -> Unit = {}, // uncomment for API pagination
) {
    // Pagination via snapshotFlow — uncomment for API pagination
    ...
    LazyColumn(
        // state = listState, // uncomment for API pagination
        modifier = Modifier
            .padding(4.dp)
            .fillMaxSize()
            .background(black1),
        ...
        // Loading indicator — uncomment for API pagination
...
fun ExerciseListItem(
    exerciseListItem: MovementEntity,
    onClick: (MovementEntity) -> Unit,
) {
    Button(
        modifier = Modifier
            .fillMaxWidth(),
        ...
        Row(
            ...
            // AsyncImage — uncomment when exercises have image URLs
            // AsyncImage(
            //     model = exerciseListItem.gifUrl,
